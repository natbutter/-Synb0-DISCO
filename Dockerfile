...
RUN pip3 install torch==1.1.0 torchvision==0.3.0 numpy==1.18 scipy==1.4 Pillow==4.3.0 dominate==2.4 nibabel==3.0
...
RUN dos2unix /extra/pipeline.sh


CMD ["/bin/bash", "/extra/pipeline.sh"]
